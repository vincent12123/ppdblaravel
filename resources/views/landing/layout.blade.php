...
<head>
    ...
    <meta name="description" content="Penerimaan Peserta Didik Baru (PPDB) Online - SMK Karya Bangsa Sintang">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>@yield('title', 'PPDB Online - Karya Bangsa Sintang')</title>
